...
/* package colorise-0.1.0.0 */
#ifndef VERSION_colorise
#define VERSION_colorise "0.1.0.0"
#endif /* VERSION_colorise */
#ifndef MIN_VERSION_colorise
#define MIN_VERSION_colorise(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_colorise */
...
#define CURRENT_COMPONENT_ID "colorise-0.1.0.0-HQlQJVDUg7G8Zqt32Hrals-colorise"
